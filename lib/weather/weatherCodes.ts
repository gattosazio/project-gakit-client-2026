...
const CONDITIONS: Record<number, WeatherCondition> = {
  ...
  56: { label: 'Drizzle', icon: CloudDrizzle },
  57: { label: 'Heavy drizzle', icon: CloudDrizzle },
  61: { label: 'Light rain', icon: CloudRain },
  63: { label: 'Rain', icon: CloudRain },
  65: { label: 'Heavy rain', icon: CloudRain },
  66: { label: 'Rain', icon: CloudRain },
  67: { label: 'Heavy rain', icon: CloudRain },
  71: { label: 'Light rain', icon: CloudRain },
  73: { label: 'Rain', icon: CloudRain },
  75: { label: 'Heavy rain', icon: CloudRain },
  77: { label: 'Heavy rain', icon: CloudRain },
  80: { label: 'Light showers', icon: CloudSunRain },
  81: { label: 'Showers', icon: CloudSunRain },
  82: { label: 'Heavy showers', icon: CloudSunRain },
  85: { label: 'Showers', icon: CloudSunRain },
  86: { label: 'Heavy showers', icon: CloudSunRain },
  95: { label: 'Thunderstorm', icon: CloudLightning },
  96: { label: 'Severe Thunderstorm', icon: CloudLightning },
