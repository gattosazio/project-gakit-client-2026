...
export function PublicHeader({
  ...
  return (
    <>
    <header className="fixed top-3 inset-x-3 md:top-4 md:left-1/2 md:-translate-x-1/2 md:inset-x-auto md:w-[calc(100%-3rem)] md:max-w-5xl z-[1200] isolate rounded-full bg-white/92 shadow-[0_4px_20px_rgba(15,23,42,0.08)] border border-slate-200/80 ring-1 ring-slate-900/5 md:bg-white/90 md:backdrop-blur-xl md:border-white/80 md:shadow-[0_12px_36px_rgba(15,23,42,0.1),inset_0_1px_0_0_rgba(255,255,255,0.9)]">
    ...
    <nav className="pointer-events-none fixed bottom-0 left-0 right-0 z-[1200] px-4 pb-2 md:hidden">
      <div className="pointer-events-auto mx-auto flex max-w-sm items-center justify-center gap-1.5 rounded-2xl bg-white/92 p-1.5 shadow-[0_8px_30px_rgba(15,23,42,0.12)] border border-slate-200/80 ring-1 ring-slate-900/5 md:bg-white/85 md:backdrop-blur-xl md:border-white/60 md:ring-slate-200/80">
        <button
          onClick={() => scrollToSection('hazard-map')}
