...
// friendly "server is waking up" state while the backend is cold-starting (free
// tier) instead of a silent failure, and an empty state once a load completed
// with no reports in the area.
export function MapStatusChip({ backendStatus, showEmptyState }: MapStatusChipProps) {
