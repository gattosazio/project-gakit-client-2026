...
export function WeatherChip({
  ...
  return (
    <div className={className}>
      {open ? (
        <div className="w-72 rounded-2xl bg-white/95 shadow-xl border border-slate-200/80 ring-1 ring-slate-900/5 md:bg-white/90 md:backdrop-blur-xl md:border-white/60 md:ring-slate-200/80 animate-[weatherGrow_160ms_ease-out]">
        ...
        <button
          ...
          className="flex items-center gap-2 rounded-2xl bg-white/90 px-3 py-2.5 shadow-md border border-slate-200/80 ring-1 ring-slate-900/5 md:bg-white/85 md:backdrop-blur-xl md:border-white/60 md:ring-slate-200/80 transition-all duration-150 hover:bg-white hover:shadow-lg active:scale-[0.97]"
          title={pillTooltip}
