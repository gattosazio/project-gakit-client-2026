      ...
      >
        {!hideShareLocation && (
          <button
            ...
            className="flex h-9 w-9 items-center justify-center rounded-2xl bg-white text-slate-700 shadow-md border border-slate-200/90 ring-1 ring-slate-200/80 md:bg-white/95 md:backdrop-blur-md md:border-white/80 transition-all duration-150 hover:bg-white hover:text-gakit-maroon active:bg-maroon-50 active:text-gakit-maroon active:scale-[0.94] disabled:cursor-not-allowed"
          >
            {isShareLocating ? (
        ...
        {/* Zoom & Compass Widget */}
        <div className="flex h-[96px] w-9 flex-col overflow-hidden rounded-2xl bg-white shadow-md border border-slate-200/90 ring-1 ring-slate-200/80 md:bg-white/95 md:backdrop-blur-md md:border-white/80">
          <button
            type="button"
