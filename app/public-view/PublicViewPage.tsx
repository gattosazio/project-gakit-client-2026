          ...
          <section id="hazard-map" className="min-h-[100dvh] snap-start">
            <div className="flex h-[100dvh] overflow-hidden bg-white">
              <div className="relative isolate flex-1 w-full h-full min-h-0">
                {isLoadingReports && (
                  <div className="absolute top-20 left-1/2 -translate-x-1/2 z-[1000] bg-white shadow-md border border-slate-200/90 ring-1 ring-slate-200/80 md:bg-white/95 md:backdrop-blur-md md:border-white/80 md:shadow-[0_8px_24px_rgba(0,0,0,0.08)] rounded-2xl px-4 py-2 flex items-center gap-2">
