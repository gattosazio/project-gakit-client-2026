        ...
        {activePreset.type === 'historical' ? (
          <div className="mt-1 rounded-xl bg-amber-50/60 border border-amber-200/60 p-2.5 flex flex-col gap-1.5">
            ...
            <p className="text-[10px] text-amber-700/90 leading-tight">
              Hazard maps and telemetry are generated by an experimental Physics-Informed Machine Learning (PIML) flood surrogate trained on UP DREAM 10m FLO-2D return-period benchmarks (5-Yr, 25-Yr, 100-Yr) and airborne LiDAR terrain physics (DEM, HAND, slope).
