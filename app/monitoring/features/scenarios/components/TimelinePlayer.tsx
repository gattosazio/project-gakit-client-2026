...
export function TimelinePlayer({
  ...
  return (
    <div className="hud-card absolute bottom-20 lg:bottom-6 left-1/2 -translate-x-1/2 z-10 w-[calc(100%-1.5rem)] sm:w-[95%] max-w-3xl p-3 sm:p-4 text-slate-800 pointer-events-auto">
